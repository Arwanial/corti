...
input int M_Magic=12345;//Magic Number
...
input double SELL_M_Common_Cost_Per_Point=0.02;//SELL Common Cost Per Point
 ...
 string M_Comment="buymeacoffee.com/besibes";//Comment
input int M_Slippage=100;//Slippage in points
...
//Loop into buys 
  ...
  //formulate symbol
    ...
    {
    //projected lot 
      double projlot=BUY_M_Common_Cost_Per_Point/tvol;
...
//Loop into sells
  ...
  //formulate symbol
    ...
    {
    //projected lot 
      double projlot=SELL_M_Common_Cost_Per_Point/tvol;
